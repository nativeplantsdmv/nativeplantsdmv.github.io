...
export const eventSchema: SchemaTypeDefinition = {
  ...
  fields: [
    ...
    {
      name: 'dateStart',
      title: 'Date & Time (starts)',
      description: 'e.g. 2026-05-09T13:00',
      type: 'datetime',
    },
    {
      name: 'description',
    ...
    {
      name: 'hosts',
      title: 'Hosted by (plain text)',
      type: 'string',
      description: 'e.g. CAC, SSTP Aid Community Garden group',
    },
    {
      name: 'noteType',
      title: 'Warning Note Type',
      description: 'Optional callout box before the event details',
      type: 'string',
      options: {
        list: [
...
export const nurserySchema: SchemaTypeDefinition = {
  name: 'nursery',
  title: 'Nursery',
  type: 'document',
  fields: [
    ...
    },
    {
      ...
      type: 'text',
      description: 'e.g. "Online orders only", "By appointment"',
    },
    {
      name: 'isEndorsed',
      title: '⭐ Endorsed (Top 3)',
      description: 'Shown on Home page + top of Nurseries page with green border',
      type: 'boolean',
    },
    {
      name: 'sortOrder',
      title: 'Sort Order',
      type: 'number',
      description: 'Lower numbers appear first. Endorsed nurseries sort first regardless.',
    },
  ],
  preview: {
    select: {title: 'name', url: 'url'},
    prepare({title, url}) {
      return {title, subtitle: url || '(no website)'}
    },
  },
}

export const landscapeCompanySchema: SchemaTypeDefinition = {
  ...
  fields: [
    ...
    {
      name: 'contactEmail',
      title: 'Contact Email / Notes',
      description: 'e.g. "hello@bloom-wild.com" or "text 202-747-4702"',
      type: 'string',
    },
    {
      name: 'address',
...
export const gardenSchema: SchemaTypeDefinition = {
  name: 'garden',
